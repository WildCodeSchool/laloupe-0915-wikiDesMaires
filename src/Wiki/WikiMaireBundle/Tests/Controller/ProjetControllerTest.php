...
class ProjetControllerTest extends WebTestCase
{
    ...
    public function testPageNew()
    {
        ...
        $this->assertEquals(0, $crawler->filter('form input#wiki_wikimairebundle_projet_description')->count());
        $this->assertEquals(0, $crawler->filter('form input#wiki_wikimairebundle_projet_difficulte')->count());
        ...
        $this->assertEquals(0, $crawler->filter('form input#wiki_wikimairebundle_projet_bassinPopulation')->count());
