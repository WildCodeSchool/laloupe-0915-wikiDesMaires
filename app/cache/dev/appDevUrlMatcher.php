...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/commune')) {
            // commune
            if (rtrim($pathinfo, '/') === '/commune') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'commune');
                }

                return array (  '_controller' => 'Wiki\\AdminBundle\\Controller\\CommuneController::indexAction',  '_route' => 'commune',);
            }

            // commune_show
            if (preg_match('#^/commune/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'commune_show')), array (  '_controller' => 'Wiki\\AdminBundle\\Controller\\CommuneController::showAction',));
            }

            // commune_new
            if ($pathinfo === '/commune/new') {
                return array (  '_controller' => 'Wiki\\AdminBundle\\Controller\\CommuneController::newAction',  '_route' => 'commune_new',);
            }

            // commune_create
            if ($pathinfo === '/commune/create') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_commune_create;
                }

                return array (  '_controller' => 'Wiki\\AdminBundle\\Controller\\CommuneController::createAction',  '_route' => 'commune_create',);
            }
            not_commune_create:

            // commune_edit
            if (preg_match('#^/commune/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'commune_edit')), array (  '_controller' => 'Wiki\\AdminBundle\\Controller\\CommuneController::editAction',));
            }

            // commune_update
            if (preg_match('#^/commune/(?P<id>[^/]++)/update$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('POST', 'PUT'))) {
                    $allow = array_merge($allow, array('POST', 'PUT'));
                    goto not_commune_update;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'commune_update')), array (  '_controller' => 'Wiki\\AdminBundle\\Controller\\CommuneController::updateAction',));
            }
            not_commune_update:

            // commune_delete
            if (preg_match('#^/commune/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('POST', 'DELETE'))) {
                    $allow = array_merge($allow, array('POST', 'DELETE'));
                    goto not_commune_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'commune_delete')), array (  '_controller' => 'Wiki\\AdminBundle\\Controller\\CommuneController::deleteAction',));
            }
            not_commune_delete:
        ...
        if (0 === strpos($pathinfo, '/users')) {
            ...
            if (rtrim($pathinfo, '/') === '/users') {
                ...
                return array (  '_controller' => 'Wiki\\AdminBundle\\Controller\\UsersController::indexAction',  '_route' => 'users',);
            }

            // users_show
            if (preg_match('#^/users/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'users_show')), array (  '_controller' => 'Wiki\\AdminBundle\\Controller\\UsersController::showAction',));
            }

            // users_new
            if ($pathinfo === '/users/new') {
                return array (  '_controller' => 'Wiki\\AdminBundle\\Controller\\UsersController::newAction',  '_route' => 'users_new',);
            }
            ...
            if ($pathinfo === '/users/create') {
                ...
                return array (  '_controller' => 'Wiki\\AdminBundle\\Controller\\UsersController::createAction',  '_route' => 'users_create',);
            }
            not_users_create:

            // users_edit
            if (preg_match('#^/users/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'users_edit')), array (  '_controller' => 'Wiki\\AdminBundle\\Controller\\UsersController::editAction',));
            }
            ...
            if (preg_match('#^/users/(?P<id>[^/]++)/update$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'users_update')), array (  '_controller' => 'Wiki\\AdminBundle\\Controller\\UsersController::updateAction',));
            }
            not_users_update:
            ...
            if (preg_match('#^/users/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'users_delete')), array (  '_controller' => 'Wiki\\AdminBundle\\Controller\\UsersController::deleteAction',));
            }
            not_users_delete:
        ...
        // add
        if ($pathinfo === '/projet') {
            return array (  '_controller' => 'Wiki\\AdminBundle\\Controller\\projetController::addAction',  '_route' => 'add',);
        }
